...
| required_attr_to_be_optional | An required string attribute will be optional in metric/event level. | Any Str | true |
| optional_attr_to_be_required | An optional string attribute will be required in metric/event level. | Any Str | false |
